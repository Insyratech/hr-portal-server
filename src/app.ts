...
import { registerFinanceAccountantRoutes } from './modules/finance/accountant-routes';
import { registerFinanceBankingRoutes } from './modules/finance/banking-routes';
import { registerFinanceExpenseRoutes } from './modules/finance/expense-routes';
import { registerFinanceGstRoutes } from './modules/finance/gst-routes';
import { registerFinanceIntegrationsRoutes } from './modules/finance/integrations-routes';
import { registerFinanceProcurementRoutes } from './modules/finance/procurement-routes';
import { registerFinanceReportsRoutes } from './modules/finance/reports-routes';
...
export async function buildApp(env: Env): Promise<FastifyInstance> {
  ...
  await registerFinanceSalesRoutes(app);
  await registerFinanceExpenseRoutes(app);
  await registerFinanceAccountantRoutes(app);
  await registerFinanceBankingRoutes(app);
  await registerFinanceGstRoutes(app);
